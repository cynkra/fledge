...
1. When you want to assign a version number to the current state of your R package, call `fledge::bump_version()`
1. (Optional.) Edit `NEWS.md` as appropriate. When done, call `fledge::finalize_version()`
...
1. Call `fledge::bump_version("patch")` (or `"minor"` or `"major"` as appropriate).
1. Edit `NEWS.md`, convert the changelog to a higher-level description of features and bug fixes.
1. Call `fledge::commit_version()`
