...
- Use fledge! fledge fills the `NEWS.md` for you based on informative commit messages, and increases the version number in `DESCRIPTION` (ADD REFERENCE ON WHY IT IS GOOD TO UPGRADE VERSION NUMBER). Using fledge is a discipline / a few habits that is worth learning!
...
- Run `fledge::bump_version()` regularly e.g. before every coffee break or at the end of the day.
