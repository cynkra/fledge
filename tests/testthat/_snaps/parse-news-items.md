...
# Can parse PR merge commits - external contributor
    ...
    Output
      ...
      Backtrace:
        ...
        4.   \-fledge:::parse_merge_commit(message) at fledge/R/parse-news-items.R:80:3
        5.     \-fledge:::harvest_pr_data(message) at fledge/R/parse-news-items.R:240:3
        6.       +-base::tryCatch(...) at fledge/R/parse-news-items.R:300:5
        7.       | \-base (local) tryCatchList(expr, classes, parentenv, handlers)
        8.       |   \-base (local) tryCatchOne(expr, names, parentenv, handlers[[1L]])
        9.       |     \-base (local) doTryCatch(return(expr), name, parentenv, handler)
       10.       +-base::suppressMessages(gh(glue("GET /repos/{slug}/pulls/{pr_number}"))) at fledge/R/parse-news-items.R:303:9
       11.       | \-base::withCallingHandlers(...)
       12.       \-fledge:::gh(glue("GET /repos/{slug}/pulls/{pr_number}")) at fledge/R/parse-news-items.R:303:9
