...
Unlike with development versions, we commit manually:
...
Some time passed and our SuperFrob package was accepted.
...
It is advised to push to GitHub or your preferred Git service, with `git push --tags` from the command line, or your favorite Git client.
