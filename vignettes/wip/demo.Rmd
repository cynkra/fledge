...
The newly created project will be set active for the rest of the demo.
For RStudio users, this corresponds to opening the project, e.g. by double-clicking the `SuperFrob.Rproj` file.
...
After adding some useful code to this file, it is time for the first check-in.
