...
```
    ...
    ## [32m✔[39m Setting active project to [34m'/Users/pjs/git/fledge'[39m
...
## [main (root-commit) ee7f3f2] Initial commit.
...
git log --numstat
git status
## commit ee7f3f2cb657319d3e165e65599a7684e836e46a
...
## [main b4059af] - Add support for frobmication.
...
## 
## [main d1034d0] - Add tests for frobnication.
...
## 
## [f-super-frob be4c609] Add super-frob tests.
##  1 file changed, 3 insertions(+)
...
##  new file:   R/frob.R
## 
## [f-super-frob 7ba6839] Add super-frob implementation.
##  1 file changed, 1 insertion(+)
...
##  new file:   tests/testthat/test-frob.R
## 
## [main 1cfea2e] - Super-frobnication enabled.
```
