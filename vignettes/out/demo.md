...
## [master (root-commit) 0d0bdca] Initial commit.
...
git log --numstat
git status
## commit 0d0bdca144a03ffde1146afe94312529ba19d163
...
##  new file:   NEWS.md
## 
## [master dd18e53] Initial NEWS.md .
...
## [master 62da1c7] - Add support for frobmication.
...
## 
## [master 5978bec] - Add tests for frobnication.
...
## [33m![39m Call [38;5;235m[48;5;253m[38;5;235m[48;5;253m`fledge::finalize_version()`[48;5;253m[38;5;235m[49m[39m.
## NULL
```
...
## 
## [f-super-frob 3e16f58] Add super-frob tests.
##  1 file changed, 3 insertions(+)
...
##  new file:   R/frob.R
## 
## [f-super-frob d5d8c05] Add super-frob implementation.
##  1 file changed, 1 insertion(+)
...
##  new file:   tests/testthat/test-frob.R
## 
## [master e0d7ff1] - Super-frobnication enabled.
```
...
## [33m![39m After CRAN release, call [38;5;235m[48;5;253m[38;5;235m[48;5;253m`fledge::tag_version()`[48;5;253m[38;5;235m[49m[39m and
## [38;5;235m[48;5;253m[38;5;235m[48;5;253m`fledge::bump_version()`[48;5;253m[38;5;235m[49m[39m to re-enter development mode
```

This updates the version of our package to 0.0.3.9007.
